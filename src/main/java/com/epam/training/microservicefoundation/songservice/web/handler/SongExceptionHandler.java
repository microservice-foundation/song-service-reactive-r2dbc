package com.epam.training.microservicefoundation.songservice.web.handler;
...
import com.epam.training.microservicefoundation.songservice.domain.exception.EntityExistsException;
import com.epam.training.microservicefoundation.songservice.domain.exception.EntityNotFoundException;
...
public class SongExceptionHandler extends AbstractErrorWebExceptionHandler {
  ...
  public SongExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources, ApplicationContext applicationContext,
    ...
    exceptionServerResponse = new HashMap<>();
